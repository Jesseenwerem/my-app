        ...
        <div>
            ...
            <div className='slider'>
                ...
                >
                    ...
                    <SwiperSlide><button className='button-1'><img className='slider-1' src={require("../Images/PNG/audi-.png")} alt="" /></button> </SwiperSlide>
                    ...
                    <SwiperSlide><button className='button-1'><img className='slider-2' src={require("../Images/PNG/ford.png")} alt="" /></button> </SwiperSlide>
                    <SwiperSlide><button className='button-1'><img className='slider-3' src={require("../Images/PNG/honda.png")} alt="" /></button> </SwiperSlide>
                    <SwiperSlide><button className='button-1'><img className='slider-4' src={require("../Images/PNG/lexus.png")} alt="" /></button> </SwiperSlide>
            ...
            <div className='responsive-swiper'>
                ...
                >
                    ...
                    <SwiperSlide><button className='responsive-button-1'><img className='responsive-slider-1' src={require("../Images/PNG/audi-.png")} alt="" /></button> </SwiperSlide>
                    <SwiperSlide><Link to="/Bmw"><button className='button-1'><img className='slider-4' src={require("../Images/PNG/BMW.png")} alt="" /></button> </Link></SwiperSlide>
